const { Icon, Input, Select, Switch, Button, Badge } = window.CyRokxDesignSystem_ef2ebf;
...
function EventTax() {
  ...
  const patch = (id, k, v) => setOverrides((os) => os.map((o) => (o.id === id ? { ...o, [k]: v } : o)));
  ...
  return (
    <div>
      <TaxPanelHead title="Tax" subtitle="Applied to every order and itemised on participant invoices.">
        <Button size="sm"><Icon name="save" size={15} />Save tax settings</Button>
      </TaxPanelHead>
