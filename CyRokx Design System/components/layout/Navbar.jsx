...
export function Navbar({ categories = ['Music', 'Comedy', 'Workshops', 'Sports', 'Food'], city = 'Mumbai', onSearchClick, style }) {
  return (
    <div
      style={{
        display: 'flex',
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
        ...
        <button onClick={onSearchClick} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-heading)', display: 'flex' }}>
