...
const LOOK: Record<ToastVariant, { icon: string; fg: string; bg: string }> = {
...
export function Toast({ variant = 'info', title, description, onClose, style }: ToastProps) {
